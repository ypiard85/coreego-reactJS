...
import CustomizedProgressBars from './FacebookCircularProgress'
...
const ResponsiveAppBar = () => {
  ...
  useEffect(() => {
    UserService.hasProfil()
      .then((res) => {
        dispatch({type: "AUTH_PROFIL_INIT", payload : true})
      })
        ...
        <Container>
          <Toolbar disableGutters>
            ...
            >
              <Link to="/">
                <img
                  style={{ height: "auto", width: "150px", maxWidth: "100%" }}
                  src={Logo}
                  alt={Logo}
                />
              </Link>
